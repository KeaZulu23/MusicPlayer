# Importing Required Modules & Libaries
from tkinter import *
import pygame
import os
...
class MusicPlayer:
  ...
  def __init__(self,root):
    ...
    trackframe = LabelFrame(self.root,text="Control Panel",font=("times new roman", 15,"bold"),bg="grey",fg="white",bd=5,relief=GROOVE)
    ...
    os.chdir("C:\\Users\\KIDO\\Desktop\\A-Reece-And-I'm Only-21-EP")
